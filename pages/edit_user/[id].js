...
const EditUser = () => {
    ...
    return (
     ...
     <Navbaradmin/>
      {/* content */}
    <div className="flex-1 p-10 text-xl font-bold">
    <div className="edit_user my-3 border-1 border-black bg-sky-400 ">
            <Head>
            ...
            <div className="col-md-4 mx-auto my-4 border-1 bg-sky-300 border-black p-3">
                <h2 className="text-uppercase text-black">Edit User</h2>
